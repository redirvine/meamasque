    ...
    <div className="relative h-[calc(100vh-64px)] w-full overflow-hidden bg-black">
      ...
      {about?.bio && (
        <div className="absolute inset-0 flex items-center justify-center px-8">
          <p className="max-w-2xl whitespace-pre-wrap text-center font-[family-name:var(--font-script)] text-2xl leading-relaxed text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] md:text-3xl">
            {about.bio}
          </p>
        </div>
      )}
